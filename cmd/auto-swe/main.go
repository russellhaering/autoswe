...
var (
	rootCmd = &cobra.Command{
		...
		Long:  `auto-swe is a command-line tool that uses AI to assist with Go software engineering tasks. It provides various commands for code analysis, indexing, and task automation.`,
